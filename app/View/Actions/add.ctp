<h1 class="page-heading"><?php echo __('Add Action'); ?></h1>
<div class="row">
    <div class="col-lg-12">
          <div class="the-box">
                <div class=" form">
    <?php 
		...
		<div class="form-group ">
                            <label for="frontendmodules" class="control-label col-lg-2"><?php echo __("Frontend Module");?></label>
                            <div class="col-lg-8">
                            <?php
                                   echo $this->Form->input("frontendmodules",array(
                                                                                "class" => "form-control",
                                                                                "id" => $frontendmodules,
                                                                                "error" => array("attributes" => array("wrap" => "label","for"=>$frontendmodules,"class"=> "error"))
                                                                               )
                                                          );
                             ?>
                             </div>
